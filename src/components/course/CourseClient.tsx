...
import { Facebook, Twitter, Linkedin, Share2, Mail, ChevronDown } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";
import Footer from "@/components/layout/Footer";
import { courseDetails, CourseDetails } from "@/lib/data/courseData";
...
export default function CourseClient({ course, slug }: CourseClientProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Structured Data - client-side rendering */}
      <div id="course-schema-container" dangerouslySetInnerHTML={{ __html: `
