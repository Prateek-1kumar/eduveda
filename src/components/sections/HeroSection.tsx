...
import { motion, AnimatePresence, useMotionValue, useTransform, useSpring, HTMLMotionProps } from "framer-motion";
import { Button } from "@/components/ui/button";
import { Parallax, ParallaxLayer } from "@/components/ui/parallax";
...
const heroSlides = [
  {
    ...
    bgImage: "https://images.unsplash.com/photo-1636633762833-5d1658f1e29b?q=80&w=2669&auto=format&fit=crop",
    bgPattern: "https://ext.same-assets.com/1553284940/1573868574.png",
  ...
  },
  {
    ...
    bgImage: "https://images.unsplash.com/photo-1639322537504-6427a16b0a28?q=80&w=2832&auto=format&fit=crop",
    bgPattern: "https://ext.same-assets.com/1553284940/1573868574.png",
  ...
  },
  {
    ...
    bgImage: "https://images.unsplash.com/photo-1581092921461-6484e3a2d1d3?q=80&w=2670&auto=format&fit=crop",
    bgPattern: "https://ext.same-assets.com/1553284940/1573868574.png",
...
const ParticleField: React.FC<ParticleFieldProps> = ({ count = 40, color = "white" }) => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      {particles.map((particle) => (
        <motion.div
          key={particle.id}
          className={`absolute rounded-full opacity-30 bg-${color}-400`}
          style={{
            left: `${particle.x}%`,
            top: `${particle.y}%`,
    ...
    >
      ...
      <div className="absolute inset-0 transform-style-3d">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className={`absolute inset-0 bg-gradient-to-br ${slide.overlayClass}`}></div>
      ...
      <div className="container-custom relative h-full flex items-center z-10">
        <motion.button
          ...
          whileHover={{ scale: 1.2, boxShadow: "0 0 15px rgba(255,255,255,0.5)" }}
          whileTap={{ scale: 0.9 }}
        >
        ...
        >
          ...
          <div className="flex flex-wrap gap-6 items-center">
            ...
            <Link href="/courses" className="text-white/80 hover:text-white flex items-center gap-2 transition-colors">
